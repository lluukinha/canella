  ...
  <div class="flex justify-around items-center w-full h-full">
    ...
    <div>
      ...
      <div class="flex w-full h-full">
        <div class="w-1/2">
          <div class="w-full flex justify-center chosen-cards pt-5 cursor-pointer relative" @click="checkSelection(chosenCategory)">
          <Card :card="chosenCategory.heroCard" class="hero-card absolute transition-all z-30" />
          <Card :card="chosenCategory.weaponCard" class="weapon-card transition-all absolute z-20" />
          <Card :card="chosenCategory.attackCard" class="attack-card transition-all absolute z-10" />
      </div>
        </div>
        <div class="w-1/2">
          <div class="w-full flex justify-center chosen-cards pt-5 cursor-pointer relative" @click="checkSelection(chosenCategory)">
